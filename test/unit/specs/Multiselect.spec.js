...
describe('Swatches.vue', () => {
  ...
  describe('Preselecting values', () => {
    describe('when searchable == TRUE', () => {
      describe('when multiple == TRUE', () => {
        it('should preselect passed array of values', () => {
          ...
          expect(vm.$children[0].$refs.tags.querySelector('.swatches__tag').textContent).to.contain('1')
        })
        ...
        it('should preselect passed array of objects', () => {
          ...
          expect(vm.$children[0].internalValue).to.deep.equal(vm.value)
          expect(vm.$children[0].$refs.tags.querySelector('.swatches__tag').textContent).to.contain('2')
        })
        ...
        it('should preselect passed array of objects in different order', () => {
          ...
          expect(vm.$children[0].internalValue).to.deep.equal(vm.value)
          expect(vm.$children[0].$refs.tags.querySelector('.swatches__tag').textContent).to.contain('3')
        })
        it('should set value to [] when passing null as selected', () => {
          ...
          expect(vm.$children[0].$refs.tags.querySelector('.swatches__tag')).to.equal(null)
        })
      })
    ...
    describe('when searchable == FALSE', () => {
      it('should preselect passed simple value', () => {
        ...
        expect(vm.$children[0].internalValue).to.deep.equal([vm.value])
        expect(vm.$children[0].$refs.tags.querySelector('.swatches__single').textContent).to.contain('1')
      })
      ...
      it('should preselect passed object', () => {
        ...
        expect(vm.$children[0].internalValue).to.deep.equal([vm.value])
        expect(vm.$children[0].$refs.tags.querySelector('.swatches__single').textContent).to.contain('2')
      })
    })
  })
  ...
  describe('#watch:value', () => {
    it('updates swatches private value when parent selected changes to a different value than private value', (done) => {
      const vm = new Vue({
        render (h) {
          return h(Swatches, {
            props: {
